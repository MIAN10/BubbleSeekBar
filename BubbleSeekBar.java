...
public class BubbleSeekBar extends View {
        ...
        if (isShowSectionText) {
            ...
            if (mSectionTextPosition == TextPosition.SIDES) {
                ...
                if (content >= 0 && content < 10) {
                    mPaint.getTextBounds("00", 0, "00".length(), mRectText);
                ...
                mPaint.getTextBounds("000", 0, "000".length(), mRectText);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mSectionTextPosition == TextPosition.SIDES) {
            if (isRtl) {
                canvas.drawLine(mRight, yTop, mThumbCenterX, yTop, mPaint);
            } else {
        ...
        if (mSectionTextPosition == TextPosition.SIDES) {
            if (isRtl) {
                ...
                canvas.drawLine(mThumbCenterX, yTop, mRight, yTop, mPaint);
            }
        }else{
            if (isRtl) {
                canvas.drawLine(mThumbCenterX, yTop, xLeft, yTop, mPaint);
